 ...
 * the lightweight SPV mode, a {@link com.matthewmitchell.nubitsj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link com.matthewmitchell.nubitsj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
