...
public class Block extends Message {
    ...
    /**
     * <p>A utility method that calculates how much new Nubits would be created by the block at the given height.
     * The inflation of Nubits is predictable and drops roughly every 4 years (210,000 blocks). At the dawn of
     * the system it was 50 coins per block, in late 2012 it went to 25 coins per block, and so on. The size of
     * a coinbase transaction is inflation plus fees.</p>
     *
     * <p>The half-life is controlled by {@link com.matthewmitchell.nubitsj.core.NetworkParameters#getSubsidyDecreaseBlockCount()}.
     * </p>
     */
     ...
     * {@link com.matthewmitchell.nubitsj.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
