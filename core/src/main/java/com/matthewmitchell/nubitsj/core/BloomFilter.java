...
public class BloomFilter extends Message {
     ...
     * See {@link com.matthewmitchell.nubitsj.core.BloomFilter.BloomUpdate} for a brief description of each mode. The purpose
    ...
    /**
     * Returns true if this filter will match anything. See {@link com.matthewmitchell.nubitsj.core.BloomFilter#setMatchAll()}
    ...
    public synchronized boolean applyAndUpdate(Transaction tx) {
        ...
        for (TransactionInput input : tx.getInputs()) {
            if (contains(input.getOutpoint().nubitsSerialize())) {
                return true;
            }
