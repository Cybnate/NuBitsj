...
import com.matthewmitchell.nubitsj.crypto.NativeSecp256k1;
...
public class ECKey implements EncryptableItem, Serializable {
     ...
     * usually encoded using ASN.1 format, so you want {@link com.matthewmitchell.nubitsj.core.ECKey.ECDSASignature#toASN1()}
     ...
     * @throws com.matthewmitchell.nubitsj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
