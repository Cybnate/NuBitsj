...
import com.matthewmitchell.nubitsj.crypto.EncryptedPrivateKey;
...
import org.nubits.NativeSecp256k1;
...
public class ECKey implements Serializable {
    ...
    static {
        // All clients must agree on the curve to use by agreement. Nubits uses secp256k1.
     ...
     * usually encoded using DER format, so you want {@link com.matthewmitchell.nubitsj.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Nubits protocol, they are
     * usually encoded using DER format, so you want {@link com.matthewmitchell.nubitsj.core.ECKey.ECDSASignature#encodeToDER()}
     ...
     * the {@link com.matthewmitchell.nubitsj.core.DumpedPrivateKey#toString()} method to get the string.
     *
     ...
     *
     * Because it is a critical failure if the private keys cannot be decrypted successfully (resulting of loss of all nubitss controlled
