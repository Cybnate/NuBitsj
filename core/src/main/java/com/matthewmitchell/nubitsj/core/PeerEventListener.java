...
public interface PeerEventListener {
    ...
    /**
     * Called when valid block hashes start to be downloaded and when the download stops.
     *
     * @param peer Peer that sent the block which triggered the download.
     * @param isDownloading true if the hashes started to download. false if the download stopped.
     */
    void onDownloadingHashes(Peer peer, boolean isDownloading);
     ...
     * {@link com.matthewmitchell.nubitsj.utils.Threading#SAME_THREAD}</p>
     */
