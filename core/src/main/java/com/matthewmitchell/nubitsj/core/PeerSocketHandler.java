...
import com.matthewmitchell.nubitsj.net.MessageWriteTarget;
import com.matthewmitchell.nubitsj.net.StreamParser;
...
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamParser {
     ...
     * called automatically by {@link com.matthewmitchell.nubitsj.net.NioClient} or
     * {@link com.matthewmitchell.nubitsj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
