...
public class Transaction extends ChildMessage implements Serializable {
     ...
     */
    public static final BigInteger REFERENCE_DEFAULT_MIN_TX_FEE = BigInteger.valueOf(100);
     ...
     */
    public static final BigInteger MIN_NONDUST_OUTPUT = BigInteger.valueOf(100);
    ...
    public String toString(@Nullable AbstractBlockChain chain) {
        ...
        for (TransactionOutput out : outputs) {
            ...
            try {
                ...
                s.append(" ");
                s.append(nubitsValueToFriendlyString(out.getValue()));
                s.append(" NBT");
     ...
     * features of Nubits are developed.</p>
     *
    ...
    public synchronized Sha256Hash hashForSignature(int inputIndex, byte[] connectedScript, byte sigHashType) {
        ...
        //
        //   https://en.nubits.it/wiki/Contracts
     ...
     * This is useful in certain types of <a href="http://en.nubits.it/wiki/Contracts">contracts</a>, such as
