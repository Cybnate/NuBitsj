...
public class TransactionOutput extends ChildMessage implements Serializable {
     ...
     * consume more than a third of its value in fees is not something the Nubits system wants to deal with right now,
     * so we call them "dust outputs" and they're made non standard. The choice of one third is somewhat arbitrary and
     * may change in future.</p>
     *
     * <p>You probably should use {@link com.matthewmitchell.nubitsj.core.TransactionOutput#getMinNonDustValue()} which uses
    ...
    public BigInteger getMinNonDustValue(BigInteger feePerKbRequired) {
        ...
        final BigInteger size = BigInteger.valueOf(this.nubitsSerialize().length + 148);
    ...
    */
    ...
    public String toString() {
        try {
            ...
            buf.append(Utils.nubitsValueToFriendlyString(value));
