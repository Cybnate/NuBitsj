...
public class Utils {
    ...
    public static final BigInteger COIN = new BigInteger("10000", 10);
    public static final BigInteger CENT = new BigInteger("100", 10);
    ...
    public static BigInteger toNanoCoins(String coins) {
        BigInteger bigint = new BigDecimal(coins).movePointRight(4).toBigIntegerExact();
        if (bigint.compareTo(BigInteger.ZERO) < 0)
            throw new ArithmeticException("Negative coins specified");
        if (bigint.compareTo(NetworkParameters.MAX_MONEY) > 0)
            throw new ArithmeticException("Amount larger than the total quantity of Nubitss possible specified.");
        return bigint;
    }
     ...
     */
    public static String nubitsValueToFriendlyString(BigInteger value) {
     ...
     */
    public static String nubitsValueToPlainString(BigInteger value) {
        if (value == null) {
            throw new IllegalArgumentException("Value cannot be null");
        }
                
        BigDecimal valueInNBT = new BigDecimal(value).divide(new BigDecimal(Utils.COIN));
        return valueInNBT.toPlainString();
    }
