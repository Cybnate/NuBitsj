...
public class VersionMessage extends Message {
    ...
    public static final String NubitsJ_VERSION = "0.11.3";
    ...
    public void parse() throws ProtocolException {
        ...
        myAddr = new PeerAddress(params, bytes, cursor, PeerAddress.INC_TIME_PROTOCOL);
        cursor += myAddr.getMessageSize();
        theirAddr = new PeerAddress(params, bytes, cursor, PeerAddress.INC_TIME_PROTOCOL);
