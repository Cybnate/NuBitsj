...
import com.matthewmitchell.nubitsj.signers.*;
...
import com.matthewmitchell.nubitsj.wallet.Protos.Wallet.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.matthewmitchell.nubitsj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject implements Serializable, BlockChainListener, PeerFilterProvider, KeyBag, TransactionBag {
    ...
    public Wallet(NetworkParameters params, ValidHashStore store) {
        this(Context.getOrCreate(params), new KeyChainGroup(params), store);
    }
     ...
     * {@link #loadFromFile}.
     */
    public Wallet(Context context, ValidHashStore store) {
        this(context, new KeyChainGroup(context.getParams()), store);
    }
     ...
     */
    public static Wallet fromKeys(NetworkParameters params, List<ECKey> keys, ValidHashStore store) {
        for (ECKey key : keys)
            checkArgument(!(key instanceof DeterministicKey));

        KeyChainGroup group = new KeyChainGroup(params);
        group.importKeys(keys);
        return new Wallet(params, group, store);
    }

    public Wallet(NetworkParameters params, KeyChainGroup keyChainGroup, ValidHashStore store) {
        this(Context.getOrCreate(params), keyChainGroup, store);
    }

    // TODO: When this class moves to the Wallet package, along with the protobuf serializer, then hide this.
    /** For internal use only. */
    public Wallet(Context context, KeyChainGroup keyChainGroup, ValidHashStore store) {
     ...
     * {@link com.matthewmitchell.nubitsj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(com.matthewmitchell.nubitsj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.matthewmitchell.nubitsj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(com.matthewmitchell.nubitsj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(com.matthewmitchell.nubitsj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.matthewmitchell.nubitsj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link com.matthewmitchell.nubitsj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link com.matthewmitchell.nubitsj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(com.matthewmitchell.nubitsj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.matthewmitchell.nubitsj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(com.matthewmitchell.nubitsj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(com.matthewmitchell.nubitsj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.matthewmitchell.nubitsj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.matthewmitchell.nubitsj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link com.matthewmitchell.nubitsj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link com.matthewmitchell.nubitsj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link com.matthewmitchell.nubitsj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws com.matthewmitchell.nubitsj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.matthewmitchell.nubitsj.crypto.KeyCrypter,
     ...
     * {@link com.matthewmitchell.nubitsj.crypto.KeyCrypterScrypt}.
     *
     ...
     * @param validHashStore Valid hash store
     * @param walletExtensions extensions possibly added to the wallet.
     */
    public static Wallet loadFromFile(File file, ValidHashStore validHashStore, @Nullable WalletExtension... walletExtensions) throws UnreadableWalletException {
        try {
            FileInputStream stream = null;
            try {
                stream = new FileInputStream(file);
                return loadFromFileStream(stream, validHashStore, walletExtensions);
            } finally {
    ...
    public static Wallet loadFromFileStream(InputStream stream, ValidHashStore validHashStore, @Nullable WalletExtension... walletExtensions) throws UnreadableWalletException {
        Wallet wallet = new WalletProtobufSerializer().readWallet(stream, validHashStore, walletExtensions);
        ...
        for (TransactionInput input : tx.getInputs()) {
            ...
            if (result == TransactionInput.ConnectionResult.ALREADY_SPENT) {
                if (fromChain) {
                    ...
                    log.warn("{}: {}", other.getHash(), Utils.HEX.encode(other.unsafeNubitsSerialize()));
                }
    ...
    /**
     * Note: Changes to NuDroid caused the deletion of the reset function.
     */
     ...
     * of {@link com.matthewmitchell.nubitsj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
    ...
    public Coin getBalance(CoinSelector selector) {
        ...
        try {
            ...
            CoinSelection selection = selector.select((Coin) params.getMaxMoney(), candidates);
            return selection.valueGathered;
        } finally {
            lock.unlock();
        }
     ...
     * you can use {@link com.matthewmitchell.nubitsj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link com.matthewmitchell.nubitsj.signers.TransactionSigner.MissingSignatureException}
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.matthewmitchell.nubitsj.core.Wallet#getBalance()} - the fees required
        ...
        /**
         * If not null, the {@link com.matthewmitchell.nubitsj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
    ...
    public void completeTx(SendRequest req) throws InsufficientMoneyException, IOException {
        ...
        try {
            ...
            if (!req.emptyWallet) {
                ...
                bestCoinSelection = selector.select((Coin) params.getMaxMoney(), candidates);
            ...
            // Check size.
            final int size = req.tx.unsafeNubitsSerialize().length;
    ...
    public BloomFilter getBloomFilter(int size, double falsePositiveRate, long nTweak) {
        ...
        try {
            ...
            for (TransactionOutPoint point : bloomOutPoints)
                filter.insert(point.nubitsSerialize());
            return filter;
        } finally {
            endBloomFilterCalculation();
        }
    ...
    private CoinSelection getSelection (final CoinSelector selector, List<TransactionOutput> candidates, Coin valueNeeded) throws InsufficientMoneyException {
    ...
    public FeeCalculation calculateFee(SendRequest req, Coin value, List<TransactionInput> originalInputs,
                                       List<TransactionOutput> candidates) throws InsufficientMoneyException, IOException {
        checkState(lock.isHeldByCurrentThread());
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.matthewmitchell.nubitsj.core.TransactionBroadcaster broadcaster) {
