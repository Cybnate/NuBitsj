...
import com.matthewmitchell.nubitsj.wallet.KeyChainEventListener;
...
public interface WalletEventListener extends KeyChainEventListener {
     ...
     * the object retrieved via {@link com.matthewmitchell.nubitsj.core.Transaction#getConfidence()}. It's safe to modify the
