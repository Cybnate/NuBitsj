...
public final class ClientState {
  ...
  public interface StoredClientPaymentChannelsOrBuilder
     ...
     */
    java.util.List<com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel> 
        getChannelsList();
    /**
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel getChannels(int index);
    /**
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
     ...
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    java.util.List<? extends com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannelOrBuilder> 
        getChannelsOrBuilderList();
    /**
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannelOrBuilder getChannelsOrBuilder(
        int index);
  }
  /**
  ...
  public static final class StoredClientPaymentChannels extends
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                channels_ = new java.util.ArrayList<com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel>();
                mutable_bitField0_ |= 0x00000001;
              }
              channels_.add(input.readMessage(com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel.PARSER, extensionRegistry));
              break;
            }
          }
        }
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.matthewmitchell.nubitsj.protocols.channels.ClientState.internal_static_paymentchannels_StoredClientPaymentChannels_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.matthewmitchell.nubitsj.protocols.channels.ClientState.internal_static_paymentchannels_StoredClientPaymentChannels_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels.class, com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels.Builder.class);
    }
    ...
    private java.util.List<com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel> channels_;
    /**
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    public java.util.List<com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel> getChannelsList() {
      return channels_;
    }
    /**
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    public java.util.List<? extends com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannelOrBuilder> 
        getChannelsOrBuilderList() {
      return channels_;
    }
    /**
     ...
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    public com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel getChannels(int index) {
      return channels_.get(index);
    }
    /**
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    public com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannelOrBuilder getChannelsOrBuilder(
        int index) {
      return channels_.get(index);
    }
    ...
    public static com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels parseFrom(
    ...
    public static com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels parseFrom(
    ...
    public static com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels prototype) {
    ...
    public static final class Builder extends
       ...
       implements com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannelsOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.matthewmitchell.nubitsj.protocols.channels.ClientState.internal_static_paymentchannels_StoredClientPaymentChannels_descriptor;
      }
      ...
      // Construct using com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels.newBuilder()
      private Builder() {
      ...
      public com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels getDefaultInstanceForType() {
        return com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels.getDefaultInstance();
      }

      public com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels build() {
        com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels result = buildPartial();
      ...
      public com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels buildPartial() {
        com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels result = new com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels) {
          return mergeFrom((com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels)other);
        } else {
      ...
      public Builder mergeFrom(com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels other) {
        if (other == com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels.getDefaultInstance()) return this;
        if (channelsBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannels) e.getUnfinishedMessage();
          throw e;
        } finally {
      ...
      private void ensureChannelsIsMutable() {
        if (!((bitField0_ & 0x00000001) == 0x00000001)) {
          channels_ = new java.util.ArrayList<com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel>(channels_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilder<
          com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel, com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel.Builder, com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannelOrBuilder> channelsBuilder_;
      ...
      public Builder setChannels(
          int index, com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel value) {
        if (channelsBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setChannels(
          int index, com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel.Builder builderForValue) {
        if (channelsBuilder_ == null) {
          ensureChannelsIsMutable();
       ...
       * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
       */
      public Builder addChannels(com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel value) {
        if (channelsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addChannels(
          com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel.Builder builderForValue) {
        if (channelsBuilder_ == null) {
          ensureChannelsIsMutable();
      ...
      public Builder addAllChannels(
          java.lang.Iterable<? extends com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel> values) {
        if (channelsBuilder_ == null) {
          ensureChannelsIsMutable();
       ...
       * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
       */
      public com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel.Builder getChannelsBuilder(
          int index) {
       ...
       * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
       */
      public com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel.Builder addChannelsBuilder() {
        return getChannelsFieldBuilder().addBuilder(
            com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel.getDefaultInstance());
      }
      /**
       * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
       */
      public com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel.Builder addChannelsBuilder(
          int index) {
        return getChannelsFieldBuilder().addBuilder(
            index, com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel.getDefaultInstance());
      }
      /**
       * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
       */
      public java.util.List<com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel.Builder> 
           getChannelsBuilderList() {
        return getChannelsFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel, com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel.Builder, com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannelOrBuilder> 
          getChannelsFieldBuilder() {
        if (channelsBuilder_ == null) {
  ...
  public static final class StoredClientPaymentChannel extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.matthewmitchell.nubitsj.protocols.channels.ClientState.internal_static_paymentchannels_StoredClientPaymentChannel_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.matthewmitchell.nubitsj.protocols.channels.ClientState.internal_static_paymentchannels_StoredClientPaymentChannel_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel.class, com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel.Builder.class);
    }
    ...
    public static com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel parseFrom(
    ...
    public static com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel parseFrom(
    ...
    public static com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannelOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.matthewmitchell.nubitsj.protocols.channels.ClientState.internal_static_paymentchannels_StoredClientPaymentChannel_descriptor;
      }
      ...
      // Construct using com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel getDefaultInstanceForType() {
        return com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel.getDefaultInstance();
      }

      public com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel build() {
        com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel buildPartial() {
        com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel result = new com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel) {
          return mergeFrom((com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel other) {
        if (other == com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel.getDefaultInstance()) return this;
        if (other.hasId()) {
          setId(other.getId());
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (com.matthewmitchell.nubitsj.protocols.channels.ClientState.StoredClientPaymentChannel) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "sh\030\007 \001(\014B3\n$com.matthewmitchell.nubitsj.protocols." +
