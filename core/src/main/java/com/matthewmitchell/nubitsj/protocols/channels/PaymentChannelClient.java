...
import com.matthewmitchell.nubitsj.protocols.channels.PaymentChannelCloseException.CloseReason;
...
public class PaymentChannelClient implements IPaymentChannelClient {
     ...
     *                   See {@link com.matthewmitchell.nubitsj.protocols.channels.IPaymentChannelClient.ClientConnection#acceptExpireTime(long)}
    ...
    private CloseReason receiveInitiate(Protos.Initiate initiate, Coin contractValue, Protos.Error.Builder errorBuilder)
            throws VerificationException, InsufficientMoneyException, ECKey.KeyIsEncryptedException, IOException {
     ...
     * {@link ClientConnection#destroyConnection(com.matthewmitchell.nubitsj.protocols.channels.PaymentChannelCloseException.CloseReason)} or
