...
import com.matthewmitchell.nubitsj.net.NioClient;
import com.matthewmitchell.nubitsj.net.ProtobufParser;
...
public class PaymentChannelClientConnection {
     ...
     * connection is open. The server is requested to keep the channel open for {@link com.matthewmitchell.nubitsj.protocols.channels.PaymentChannelClient#DEFAULT_TIME_WINDOW}
