 ...
 * <i>receiving party</i>. Although the underlying Nubits protocol is capable of more complex relationships than that,
...
public class PaymentChannelClientState {
    ...
    public synchronized void initiate() throws ValueOutOfRangeException, InsufficientMoneyException {
        ...
        // relies on the fact that since Nubits 0.8 time locked transactions are non-final. This will need to change
