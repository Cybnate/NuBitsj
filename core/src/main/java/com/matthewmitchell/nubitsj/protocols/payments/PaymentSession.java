...
package com.matthewmitchell.nubitsj.protocols.payments;
 ...
 * </ul>
 *
 * If initialized with a NubitsURI or a url, a network request is made for the payment request object and a
 ...
 * NOTE: sendPayment does NOT broadcast the transactions to the nubits network.
 *
...
public class PaymentSession {
     ...
     */
    public static ListenableFuture<PaymentSession> createFromNubitsUri(final NubitsURI uri) throws PaymentRequestException {
     ...
     */
    public static ListenableFuture<PaymentSession> createFromNubitsUri(final NubitsURI uri, final boolean verifyPki, @Nullable final String trustStorePath)
            throws PaymentRequestException {
        String url = uri.getPaymentRequestUrl();
        if (url == null)
            throw new PaymentRequestException.InvalidPaymentRequestURL("No payment request URL (r= parameter) in NubitsURI " + uri);
        try {
    ...
    private static ListenableFuture<PaymentSession> fetchPaymentRequest(final URI uri, final boolean verifyPki, @Nullable final String trustStorePath) {
        return executor.submit(new Callable<PaymentSession>() {
            ...
            public PaymentSession call() throws Exception {
                ...
                connection.setRequestProperty("Accept", "application/nubits-paymentrequest");
    ...
    protected ListenableFuture<Ack> sendPayment(final URL url, final Protos.Payment payment) {
        return executor.submit(new Callable<Ack>() {
            ...
            public Ack call() throws Exception {
                ...
                connection.setRequestProperty("Content-Type", "application/nubits-payment");
                connection.setRequestProperty("Accept", "application/nubits-paymentack");
