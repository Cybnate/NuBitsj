...
package com.matthewmitchell.nubitsj.script;
 ...
 * convenience methods on {@link com.matthewmitchell.nubitsj.core.Transaction}, but they are useful when working with the
...
public class ScriptBuilder {
    ...
    public static Script createInputScript(TransactionSignature signature, ECKey pubKey) {
        ...
        return new ScriptBuilder().data(signature.encodeToNubits()).data(pubkeyBytes).build();
    }

    /** Creates a scriptSig that can redeem a pay-to-pubkey output. */
    public static Script createInputScript(TransactionSignature signature) {
        return new ScriptBuilder().data(signature.encodeToNubits()).build();
    }
