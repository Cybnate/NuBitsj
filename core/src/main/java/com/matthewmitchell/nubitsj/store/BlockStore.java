...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link com.matthewmitchell.nubitsj.core.BlockChain#getChainHead()}
     * or perhaps {@link com.matthewmitchell.nubitsj.core.BlockChain#getBestChainHeight()} which will run in constant time and
