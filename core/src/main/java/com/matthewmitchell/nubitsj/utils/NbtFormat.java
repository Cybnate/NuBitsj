...
import com.matthewmitchell.nubitsj.utils.NbtAutoFormat.Style;
import static com.matthewmitchell.nubitsj.utils.NbtAutoFormat.Style.*;
 ...
 * method.  This argument can be either a {@link com.matthewmitchell.nubitsj.core.Coin}-type object or a
 ...
 * @see          com.matthewmitchell.nubitsj.core.Coin
 */
...
public abstract class NbtFormat extends Format {
    ...
    public static class Builder {
        ...
        private Style style = NbtAutoFormat.Style.CODE;
        private int scale = 0;
     ...
     * units using a currency code, for example, <code>"mNbt"</code>.
     */
    public static NbtFormat getCodeInstance(Locale locale) { return getInstance(CODE, locale); }
     ...
     */
    public static NbtFormat getInstance(Style style) { return getInstance(style, defaultLocale()); }
     ...
     */
    public static NbtFormat getInstance(Style style, int fractionPlaces) {
     ...
     */
    public static NbtFormat getInstance(Style style, Locale locale) {
     ...
     * fractional satoshis.
     */
    public static NbtFormat getInstance(Style style, Locale locale, int fractionPlaces) {
    ...
    /**
      ...
      * {@link com.matthewmitchell.nubitsj.core.Coin} object that represents the parsed value.
      * @see java.text.NumberFormat */
    @Override
