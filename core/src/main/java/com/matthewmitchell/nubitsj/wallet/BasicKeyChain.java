...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws com.matthewmitchell.nubitsj.store.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws com.matthewmitchell.nubitsj.store.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(com.matthewmitchell.nubitsj.crypto.KeyCrypter,
