...
import com.matthewmitchell.nubitsj.core.BloomFilter;
 ...
 * {@link com.matthewmitchell.nubitsj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link com.matthewmitchell.nubitsj.crypto.MnemonicCode},
 ...
 * {@link com.matthewmitchell.nubitsj.crypto.DeterministicKey#serializePubB58(com.matthewmitchell.nubitsj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link com.matthewmitchell.nubitsj.crypto.DeterministicKey#deserializeB58(com.matthewmitchell.nubitsj.crypto.DeterministicKey, String, com.matthewmitchell.nubitsj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(com.matthewmitchell.nubitsj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link com.matthewmitchell.nubitsj.crypto.DeterministicHierarchy} and
 * {@link com.matthewmitchell.nubitsj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     * The returned key can be serialized and then passed into {@link #watch(com.matthewmitchell.nubitsj.crypto.DeterministicKey)}
