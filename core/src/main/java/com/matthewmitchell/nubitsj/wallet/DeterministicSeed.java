...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link com.matthewmitchell.nubitsj.crypto.MnemonicCode} for more
     ...
     *
     * @throws com.matthewmitchell.nubitsj.crypto.MnemonicException if check fails
     */
