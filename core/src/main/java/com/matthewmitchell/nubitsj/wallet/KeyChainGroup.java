...
import com.matthewmitchell.nubitsj.crypto.ChildNumber;
...
/**
 * <p>A KeyChainGroup is used by the {@link com.matthewmitchell.nubitsj.core.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws com.matthewmitchell.nubitsj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link com.matthewmitchell.nubitsj.crypto.KeyCrypterScrypt}.
     *
     * @throws com.matthewmitchell.nubitsj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
