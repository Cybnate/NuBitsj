...
class NewBlock {
    ...
    public void solve() { /* NuBits has no solving */ }
...
public class FullBlockTestGenerator {
    ...
    public RuleList getBlocksToTest(boolean runBarelyExpensiveTests, boolean runExpensiveTests, File blockStorageFile) throws ScriptException, ProtocolException, IOException {
        ...
        Block b56;
        try {
            b56 = new Block(params, b57.block.nubitsSerialize());
        ...
        Block b56p2;
        try {
            b56p2 = new Block(params, b57p2.block.nubitsSerialize());
        } catch (ProtocolException e) {
            throw new RuntimeException(e); // Cannot happen.
        }
        ...
        Block b71 = new Block(params, b72.block.nubitsSerialize());
    ...
    class BlockAndValidity extends Rule {
        ...
        boolean sendOnce; // We can throw away the memory for this block once we send it the first time (if nud asks again, its broken)
