...
import com.matthewmitchell.nubitsj.signers.StatelessTransactionSigner;
...
public class WalletTest extends TestWithWallet {
    ...
    public void basicSpendingWithEncryptedWallet() throws Exception {
        Wallet encryptedWallet = new Wallet(params, null);
    ...
    public void isWatching() {
        ...
        Wallet watchingWallet = Wallet.fromWatchingKey(params, wallet.getWatchingKey().dropPrivateBytes().dropParent(), null);
    ...
    public void watchingWallet() throws Exception {
        ...
        Wallet watchingWallet = Wallet.fromWatchingKey(params, DeterministicKey.deserializeB58(null, serialized, params), null);
    ...
    public void watchingWalletWithCreationTime() throws Exception {
        ...
        Wallet watchingWallet = Wallet.fromWatchingKey(params, watchKey, 1415282801, null);
        DeterministicKey key2 = watchingWallet.freshReceiveKey();
        assertEquals(myKey, key2);
    ...
    public void sendRequestP2PKTest() {
        ...
        SendRequest req = SendRequest.to((NetworkParameters) notMyAddr.getSelectedCoinDetails(), key, SATOSHI.multiply(12));
    ...
    public void completeTxPartiallySignedThrows() throws Exception {
        sendMoneyToWallet(wallet, CENT.multiply(2), wallet.freshReceiveKey(), AbstractBlockChain.NewBlockType.BEST_CHAIN);
        SendRequest req = SendRequest.emptyWallet(new ECKey().toAddress(params));
        wallet.completeTx(req);
        // Delete the sigs
        for (TransactionInput input : req.tx.getInputs())
            input.setScriptBytes(new byte[]{});
        Wallet watching = Wallet.fromWatchingKey(params, wallet.getWatchingKey().dropParent().dropPrivateBytes(), null);
    ...
    public void sendCoinsNoBroadcasterTest() throws InsufficientMoneyException, IOException {
    ...
    public void sendCoinsWithBroadcasterTest() throws InsufficientMoneyException, IOException {
        ...
        SendRequest req = SendRequest.to((NetworkParameters) notMyAddr.getSelectedCoinDetails(), key, Coin.CENT);
        wallet.sendCoins(req);
    }
    ...
    public void fromKeys() {
        ...
        Wallet wallet = Wallet.fromKeys(params, Arrays.asList(key), null);
