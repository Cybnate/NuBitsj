...
public class PeerAddressTest
{
    ...
    public void testPeerAddressRoundtrip() throws Exception {
        // copied verbatim from https://en.nubits.it/wiki/Protocol_specification#Network_address
        ...
        String reserialized = Utils.bytesToHexString(pa.nubitsSerialize());
    ...
    public void testNubitsSerialize() throws Exception {
        ...
        assertEquals("000000000000000000000000000000000000ffff7f000001208d",
                Utils.bytesToHexString(pa.nubitsSerialize()));
    }
}
