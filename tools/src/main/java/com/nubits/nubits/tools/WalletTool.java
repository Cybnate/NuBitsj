...
import com.matthewmitchell.nubitsj.protocols.payments.PaymentRequestException;
...
public class WalletTool {
    ...
    public static class Condition {
        ...
        public boolean matchNubitss(BigInteger comparison) {
            try {
    ...
    private static void send(List<String> outputs, BigInteger fee, String lockTimeStr, boolean allowUnconfirmed) throws VerificationException {
        try {
            ...
            System.err.println("Insufficient funds: have " + Utils.nubitsValueToFriendlyString(wallet.getBalance()));
        }
    }
                ...
                wallet.addEventListener(new AbstractWalletEventListener() {
                    ...
                    public synchronized void onChange() {
                        ...
                        if (condition.matchNubitss(balance)) {
                            System.out.println(Utils.nubitsValueToFriendlyString(balance));
                            latch.countDown();
                        }
                    }
                });
