...
import com.matthewmitchell.nubitsj.core.DownloadProgressTracker;
...
import wallettemplate.utils.NuBitsUIModel;
...
public class MainController {
    ...
    private NuBitsUIModel model = new NuBitsUIModel();
    ...
    private void showNuBitsSyncMessage() {
        syncItem = Main.instance.notificationBar.pushItem("Synchronising with the NuBits network", model.syncProgressProperty());
    }
