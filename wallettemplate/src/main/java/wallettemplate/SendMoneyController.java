...
public class SendMoneyController {
    ...
    public void send(ActionEvent event) {
        ...
        try {
            ...
            if (amount.equals(Main.nubits.wallet().getBalance()))
            ...
            informationalAlert("Could not fetch transaction fee", "The transaction fee could be be obtained from a trusted server.");
