...
/**
 * A class that exposes relevant nubits stuff as JavaFX bindable properties.
 */
public class NuBitsUIModel {
    ...
    public NuBitsUIModel() {
    }

    public NuBitsUIModel(Wallet wallet) {
        setWallet(wallet);
    }
